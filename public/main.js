...
var routes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_3__["DashboardComponent"], canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_2__["ProfileComponent"], canActivate: [_guards_auth_guards__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] }
];
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_3__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _guards_auth_guards__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]],
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (JSON.parse(JSON.stringify(data)).success) {
                _this.authService.storeUserData(JSON.parse(JSON.stringify(data)).token, JSON.parse(JSON.stringify(data)).user);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_validate_service__WEBPACK_IMPORTED_MODULE_1__["ValidateService"],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.loadToken = function () { this.authToken = localStorage.getItem('token'); };
...
module.exports = __webpack_require__(/*! C:\Users\Admin\Desktop\des projets\meanAuthapp\angular-authMean\src\main.ts */"./src/main.ts");
